...
use rust_project::{explore, explore_default, ExploreConfig, ExplorationStrategy, SymU64};
use std::sync::Arc;
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("   Result: {} paths explored, {} satisfiable",
    ...
    println!("   Variables: {}, Constraints: {}",
             ...
             result.manager_stats.constraint_count);
    println!();
    ...
    println!("   Result: {} unsatisfiable paths detected",
    ...
    println!("   Result: {} variables, {} constraints",
             result.manager_stats.variable_count,
             result.manager_stats.constraint_count);
    println!("   Paths: {} explored, {} satisfiable",
             result.exploration_result.paths_explored,
             result.exploration_result.satisfiable_paths);
    println!();
    ...
    println!("   Result: {} variables created",
             result.manager_stats.variable_count);
    println!();
    ...
    let _result = explore_default(|manager| {
        ...
        println!("   Concrete values: sum={:?}, diff={:?}, prod={:?}",
                 sum.concrete_value(), diff.concrete_value(), prod.concrete_value());
        Ok(())
    })?;
